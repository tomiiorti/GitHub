...
<body class="body d-flex justify-content-center align-items-center">
    <div class="col-md-6 d-flex justify-content-center align-items-center">
        <form id="editForm" class="col-md-11" action="editar_usuario.php" method="POST">
            ...
            <hr> <!-- Línea divisora -->
            <div class="secc">
                <label for="Id" class="form-label col-md-2">Nombre</label>
                <input type="text" class="form-control" id="name" name="name" value="<?php echo $row["Nombre"]; ?>">
            </div>
            <hr> <!-- Línea divisora -->
            <div class="secc">
            ...
            <div class="secc">
                ...
                <select class="form-select" id="rol" name="rol">
                    <option value="0" <?php if ($row["Rol"] == 0) echo ' selected'; ?>>Administrador</option>
                    <option value="1" <?php if ($row["Rol"] == 1) echo ' selected'; ?>>Usuario</option>
                </select>
            </div>
            <hr> <!-- Línea divisora -->
